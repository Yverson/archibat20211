...
import 'ARCHIMEDIADETAILV1.dart';

class ARCHIMEDIAV1Screen extends StatefulWidget {
...
class ARCHIMEDIAScreenState extends State<ARCHIMEDIAV1Screen> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<List<ProductModel>> fetchData() async {
    final response = await http
        .get(Uri.parse('http://cgeciapi.gaddielsoftware.com/api/Mediav1'));
                    ...
                    itemBuilder: (context, index) {
                      return GestureDetector(
                        onTap: (){
                          ...
                          ARCHIMEDIADETAILV1Screen(model: snapshot.data![index]).launch(context);
                        },
                        child: Padding(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                Image.network('http://cgeciapi.gaddielsoftware.com/PhotoArchibat/${snapshot.data![index].img}',
                                    height: 153,
                                    fit: BoxFit.fill),
                                SizedBox(height: 3),
