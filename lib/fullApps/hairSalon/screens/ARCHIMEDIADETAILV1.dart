...
class ARCHIMEDIADETAILV1Screen extends StatefulWidget {
  static String tag = '/DiscoverBottomNavigationBarScreen';
  final ProductModel? model;

  const ARCHIMEDIADETAILV1Screen({Key? key, this.model}) : super(key: key);

  @override
  _ARCHIMEDIADETAILScreenState createState() => _ARCHIMEDIADETAILScreenState();
}

class _ARCHIMEDIADETAILScreenState extends State<ARCHIMEDIADETAILV1Screen> {
  ...
  Future<List<ProductModel>> fetchData() async {
    final response = await http
        .get(Uri.parse('http://cgeciapi.gaddielsoftware.com/api/MediaDv1?type=${widget.model!.info}'));
                  ...
                  children: [
                    PageView.builder(
                      ...
                      itemBuilder: (context, i) {
                        return Image.network('http://cgeciapi.gaddielsoftware.com/PhotoArchibat/${widget.model!.img}', fit: BoxFit.cover);
                      },
                      onPageChanged: (value) {
                      ...
                      return GestureDetector(
                        ...
                        child: Padding(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                Image.network('http://cgeciapi.gaddielsoftware.com/PhotoArchibat/${snapshot.data![index].info}/${snapshot.data![index].img}',
                                    height: 153,
                                    fit: BoxFit.fill),
                                SizedBox(height: 3),
    ...
    return GestureDetector(
      child: Container(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.center,
          children: <Widget>[
            Image.network('http://cgeciapi.gaddielsoftware.com/PhotoArchibat/${model.info.toString()}/${model.img}',
