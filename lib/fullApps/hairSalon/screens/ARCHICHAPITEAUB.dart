...
class ARCHICHAPITEAUBScreen extends StatefulWidget {
  static String tag = '/DiscoverBottomNavigationBarScreen';

  @override
  ARCHICHAPITEAUBScreenState createState() => ARCHICHAPITEAUBScreenState();
}

class ARCHICHAPITEAUBScreenState extends State<ARCHICHAPITEAUBScreen> {
  var data;
  ...
  Future<List<ProductModel>> fetchData() async {
    final response = await http
        .get(Uri.parse('http://cgeciapi.gaddielsoftware.com/api/Chapiteau?type=CHAPITEAUB'));
