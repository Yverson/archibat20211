...
class ARCHIAUDITORIUMScreen extends StatefulWidget {
  static String tag = '/DiscoverBottomNavigationBarScreen';

  @override
  ARCHIAUDITORIUMScreenState createState() => ARCHIAUDITORIUMScreenState();
}

class ARCHIAUDITORIUMScreenState extends State<ARCHIAUDITORIUMScreen> {
  var data;
  ...
  Future<List<ProductModel>> fetchData() async {
    final response = await http
        .get(Uri.parse('http://cgeciapi.gaddielsoftware.com/api/Chapiteau?type=AUDITORIUM'));
